...
# IMPORTANT: This is a modified version of speedtest-cli by Matt Martz
# The modifications are needed to automatically calculate optimum amule upload speed (by shell script)
# List of Changes:
#   - disabled download speed calculation
#   - added creation of an output file that contains amule upload speed optimum value
#   - changed user agent for privacy reasons
...
user_agent = 'Mozilla/5.0 (Windows NT 5.1; rv:38.0) Gecko/20100101 Firefox/38.0'
source = None
shutdown_event = None
...
def speedtest():
    ...
    try:
        ...
        pass
    parser.add_argument('--cspath', default='./', help='Specify path of calculatedUploadSpeed.out file')
...
#           ((dlspeed / 1000 / 1000) * args.units[1], args.units[0]))
    ...
    calculatedUploadSpeed = int((ulspeed / 1000 / 1000) * 400)
    f = open(args.cspath + 'calculatedUploadSpeed.out', 'w')
    print >> f, calculatedUploadSpeed
    f.close()           
